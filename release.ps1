...
$ProjectPath  = ".\McfEditor\McfEditor.csproj"
$PublishDir   = ".\McfEditor\bin\Release\net8.0-windows\win-x64\publish"
$ArtifactsDir = ".\.artifacts"
$ZipName      = "McfEditor_$Tag" + "_win-x64.zip"
...
Write-Host ""
Write-Host "McfEditor release script" -ForegroundColor Green
...
gh release create $Tag $ZipPath --title "McfEditor $Tag" --notes-file $ReleaseNotes
if ($LASTEXITCODE -ne 0) {
