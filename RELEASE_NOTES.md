...
- Improved overall application branding and visual consistency.
- Aligned README.md
- Added export of a single image from the right-side actions panel.
- Added export of a folder or image through the tree view context menu.
